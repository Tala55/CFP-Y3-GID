...
function Management() {
    return (
        <div  style={{marginTop:'40px',justifyContent:'center',marginLeft:'40px',color:"red"}}>
  
        
        <Link to="/Todolist" className='kill' id="img1" ><h4 style={{marginTop:"250px",textAlign:'center'}}>TodoList </h4></Link>
